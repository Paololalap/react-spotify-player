...
const Desktop = ({ className }) => {
  ...
  return (
    <div className={className}>
      ...
      <MainContent className="hidden sm:block sm:max-h-[97vh] sm:w-full sm:overflow-y-hidden sm:rounded-lg ">
        {/* Background */}
        <div className="hidden sm:relative sm:block sm:min-h-screen sm:w-full sm:-translate-y-[4rem] sm:rounded-lg  sm:bg-fixed sm:bg-left ">
          <img
            src="https://lastfm.freetls.fastly.net/i/u/ar0/41bf054f9ab8ba7e2e60be69368fef17.jpg"
            alt=""
            className="sm:bg-fixed sm:bg-no-repeat sm:object-contain"
          />
          ...
          <Showcase />
          <div className="hidden sm:absolute sm:top-[23.5rem] sm:block sm:min-h-screen sm:w-full sm:bg-gradient-to-b sm:from-red-950 sm:via-black sm:via-15% sm:to-black">
